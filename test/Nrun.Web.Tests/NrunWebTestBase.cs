...
{
    public abstract class NrunWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NrunWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NrunWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NrunDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NrunDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NrunDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NrunDbContext, Task<T>> func)
        {
            T result;
